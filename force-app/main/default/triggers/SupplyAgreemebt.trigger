trigger SupplyAgreemebt on Supply_Agreement__c (After insert , After Update) {
   ...
   if(trigger.isAfter && trigger.isUpdate){
        ...
        for(Supply_Agreement__c eSam : trigger.new){
        ...
        new UtilityControllerClass().reShareTheRecordsToAccOwner(accountNewMap,accountOldMap,'Supply_Agreement','Account');
